...
{
    /**
     * Array items used in array access implementation.
     *
     * @var array
     */
    private $arrayAccess = [];
    ...
    {
        return array_key_exists($offset, $this->arrayAccess);
    }
    ...
    {
        return $this->arrayAccess[$offset];
    }
